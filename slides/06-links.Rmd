...
This would use the default priors for random effect standard deviations (half student t priors with 3 degrees of freedom and an appropriate scale parameter)
